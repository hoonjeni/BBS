...
<body>
	...
	if (session.getAttribute("userID") != null) {
		userID = (String) session.getAttribute("usesrID");
	}
	%>
	...
	<div class="container">
		<div class="jumbotron">
			<div class="container">
				<h1>웹 사이트 소개</h1>
				<p>이 웹 사이트는 부트스트랩으로 만든 jsp 웹사이트 입니다.최소한의 간단한 로직만을 이요해서
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="images/은하수1.jpg">
				</div>
				<div class="item">
					<img src="images/은하수2.jpg">
				</div>
				<div class="item">
					<img src="images/은하수3.jpg">
				</div>
			</div>
			<a class="left carousel-control" href="#myCarousel" data-slide="prev">
				...
				class="glyphicon glyphicon-cheron-right"></span>
			</a>
		</div>
	</div>
